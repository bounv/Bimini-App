      ...
      <div>
        ...
        <div className='productsContent'>
          ...
          <div className='royale'>
            <Link to={"/products/" + 2}><img className='bottleOne' src={bottleOne}/>
          ...
          <div className='Serenity'>
            <Link to={"/products/" + 1}><img className='bottleTwo' src={bottleTwo}/>
          ...
          <div className='vaticanPondWater'>
            <Link to={"/products/" + 0}><img className='bottleThree' src={bottleThree}/>
